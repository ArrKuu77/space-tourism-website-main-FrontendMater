...
const HomeMenuDisplayFunction = () => {
  Mother.style.backgroundImage = "url(starter-code/assets/home/background-home-desktop.jpg)";
...
HomeMobile.addEventListener("click",() => {
  HomeMenuDisplayFunction();
  Mother.style.backgroundImage = "url(starter-code/assets/home/background-home-mobile.jpg)";
})
const DestinationDisplayFunction = () => {
  Mother.style.backgroundImage = "url(starter-code/assets/destination/background-destination-desktop.jpg)"
  bodyContainer.innerHTML="";
  ...
  RightImg.src= "starter-code/assets/destination/image-moon.webp";
...
DestinationMobile.addEventListener("click",() => {
  DestinationDisplayFunction();
  Mother.style.backgroundImage = "url(starter-code/assets/destination/background-destination-mobile.jpg))"
})

CrewMenu.addEventListener("click", () => {
  SliderFunction(CrewMenu);
  Mother.style.backgroundImage = "url(starter-code/assets/crew/background-crew-desktop.jpg)";
  bodyContainer.innerHTML = "";
...
CrewMobile.addEventListener("click",() => {
  Mother.style.backgroundImage = "url(starter-code/assets/crew/background-crew-mobile.jpg)";
  bodyContainer.innerHTML = "";
...
TechnologyMenu.addEventListener("click", () => {
  ...
  Mother.style.backgroundImage = " url(starter-code/assets/technology/background-technology-desktop.jpg)";
  bodyContainer.innerHTML = "";
...
TechnologyMobile.addEventListener("click",() => {
  ...
  Mother.style.backgroundImage = " url(starter-code/assets/technology/background-technology-mobile.jpg)"
